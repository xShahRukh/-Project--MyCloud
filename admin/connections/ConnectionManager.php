...
class ConnectionManager
{
	...
	{
		return $this->byId( "cloud_at_localhost" );
	}
	...
	protected function _setConnectionsData()
	{
		...
		$data = array();
		$data["dbType"] = 0;
		$data["connId"] = "cloud_at_localhost";
		$data["connName"] = "cloud at localhost";
		$data["connStringType"] = "mysql";
		$data["connectionString"] = "mysql;localhost;root;;;cloud;;1"; //currently unused
		
		$this->_connectionsIdByName["cloud at localhost"] = "cloud_at_localhost";
		...
		$data["connInfo"][2] = "";
		$data["connInfo"][3] = "";
		$data["connInfo"][4] = "cloud";
		$data["connInfo"][5] = ""; //currently unused
		$data["connInfo"][6] = "1"; //currently unused
		$data["ODBCString"] = "DRIVER={MySQL ODBC 3.51 Driver};Server=localhost;Uid=root;Pwd=;Database=cloud;OPTION=3";
		$connectionsData["cloud_at_localhost"] = $data;
	...
	protected function _setTablesConnectionIds()
	{
		...
		$connectionsIds["users"] = "cloud_at_localhost";
