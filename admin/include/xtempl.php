...
<?php } ?>
	...
	if($params["ctype"]=="Gauge")
		$refrFunction="Runner.updateGaugeChart('".$chartname."', chart)";
	else
		$refrFunction="Runner.updateChart('".$chartname."', ".($showDetails ? "true" : "false").", ".($params["dash"] ? "true" : "false").", chart)";
	...
	if($refresh!="0" && !isMobile())
		echo "setInterval( function() {" . $refrFunction . "; },".$refresh.");";
	?>
	})();
	//]]>
</script>
