...
class tDAL
{
	var $tblcloud_at_localhost__admin;
	var $tblcloud_at_localhost__users;
	var $lstTables;
	var $Table = array();
	...
	function FillTablesList()
	{
		if($this->lstTables)
			return;
		$this->lstTables[] = array("name" => "admin", "varname" => "cloud_at_localhost__admin", "altvarname" => "admin", "connId" => "cloud_at_localhost", "schema" => "", "connName" => "cloud at localhost");
		$this->lstTables[] = array("name" => "users", "varname" => "cloud_at_localhost__users", "altvarname" => "users", "connId" => "cloud_at_localhost", "schema" => "", "connName" => "cloud at localhost");
	}
