...
class ProjectSettings
{
	...
	{
		return $this->getTableType() == PAGE_DASHBOARD ? $this->getDashFieldData($field, "EditFormat") : $this->getFieldData($field, "EditFormat");
	}
	...
	{
		return $this->getNType() == DASHBOARD_SEARCH ? $this->getDashFieldData($field, "LookupUnique") : $this->getFieldData($field, "LookupUnique");
	}

	function getLookupOrderBy($field)
	{
		return $this->getNType() == DASHBOARD_SEARCH ? $this->getDashFieldData($field, "LookupOrderBy") : $this->getFieldData($field, "LookupOrderBy");
	}
	...
	*/
	...
	{
		return $this->getTableType() == PAGE_DASHBOARD ? $this->getDashFieldData($field, "searchOptionsList") : $this->getFieldData($field, "searchOptionsList");
	}
	
	
	function getDefaultSearchOption($field)
	{
		$defaultOpt = $this->getTableType() == PAGE_DASHBOARD ? $this->getDashFieldData($field, "defaultSearchOption") : $this->getFieldData($field, "defaultSearchOption");
